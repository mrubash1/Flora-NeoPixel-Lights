...
uint8_t brightness = 30; // brightness
...
void loop() {
  ...
  switch (lightMode) {
    ...
    case 2: 
      ...
      break;
    case 3:
      pulse(strip.Color(205,0,137), 0); //pink
      colorWipe(strip.Color(0, 0, 0), 0);
      break;
    case 4:
      pulse(strip.Color(255,170,0), 0); //yellow
      colorWipe(strip.Color(0, 0, 0), 0);
      break;
    case 5: //Rainbow volume responsive
      volMeter(1,255); 
      break;
    case 6: //Blue Green volume responsive
      volMeter(1,120); 
      break;
  }
